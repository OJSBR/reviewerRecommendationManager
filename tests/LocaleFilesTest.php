...
class LocaleFilesTest extends PKPTestCase
{
    ...
    public const PLACEHOLDERS = [
        'plugins.generic.reviewerRecommendationManager.settings.usageWarning' => ['{$usage}'],
    ];
    ...
    public function testEveryKeyTheCodeUsesExists(): void
    {
        ...
        preg_match_all('/plugins\.generic\.reviewerRecommendationManager\.[a-zA-Z0-9_.]*[a-zA-Z0-9_]/', $sources, $m);
